...
module "cis_iam_admins" {
  ...
  policy_statements     = ["Allow group ${module.cis_iam_admins.group_name} to inspect users in tenancy",
                           "Allow group ${module.cis_iam_admins.group_name} to manage users in tenancy where target.group.name != 'Administrators'",
