...
locals {
  ...
  dynamic_groups_defined_tags = length(local.all_dynamic_groups_defined_tags) ? local.all_dynamic_groups_defined_tags : local.default_dynamic_groups_defined_tags
  dynamic_groups_freeform_tags = length(local.all_dynamic_groups_freeform_tags) ? local.all_dynamic_groups_freeform_tags : local.default_dynamic_groups_freeform_tags
