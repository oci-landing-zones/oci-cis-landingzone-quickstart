...
module "lz_notifications" {
  ...
  rules = {
    ("${var.service_label}-notify-on-iam-changes-rule") = {
      ...
      topic_id            = module.lz_topics[local.security_topic_name].id
      defined_tags        = null
    },
  ...
  ("${var.service_label}-notify-on-network-changes-rule") = {
      ...
      actions_is_enabled  = true
      actions_description = "Sends notification via ONS"
      topic_id            = module.lz_topics[local.network_topic_name].id
      defined_tags        = null
    },
  ...
  ("${var.service_label}-notify-on-storage-changes-rule") = {
      ...
      actions_is_enabled  = true
      actions_description = "Sends notification via ONS"
      topic_id            = module.lz_topics[local.storage_topic_name].id
      defined_tags        = null
    },
  ...
  ("${var.service_label}-notify-on-database-changes-rule") = {
      ...
      actions_is_enabled  = true
      actions_description = "Sends notification via ONS"
      topic_id            = module.lz_topics[local.database_topic_name].id
      defined_tags        = null
    },
  ...
  ("${var.service_label}-notify-on-governance-changes-rule") = {
      ...
      actions_is_enabled  = true
      actions_description = "Sends notification via ONS"
      topic_id            = module.lz_topics[local.governance_topic_name].id
      defined_tags        = null
    },
  ...
  ("${var.service_label}-notify-on-compute-changes-rule") = {
      ...
      actions_is_enabled  = true
      actions_description = "Sends notification via ONS"
      topic_id            = module.lz_topics[local.compute_topic_name].id
      defined_tags        = null
    }
