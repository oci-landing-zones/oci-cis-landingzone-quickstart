...
locals {
  ...
  adbexainfra_admin_group_name_suffix   = var.use_existing_groups == false ? "adbexainfra-admin-group" : data.oci_identity_groups.existing_adbexainfra_admin_group.groups[0].name
