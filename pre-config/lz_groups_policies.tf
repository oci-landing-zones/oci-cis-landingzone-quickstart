  ...
  policies = {
    ...
    "${each.key}-auditor-root-policy" = {
      ...
      statements = [
        ...
        "Allow group ${each.value.group_name_prefix}${local.auditor_group_name_suffix} to read instances in tenancy",
        "Allow group ${each.value.group_name_prefix}${local.auditor_group_name_suffix} to read load-balancers in tenancy",
        "Allow group ${each.value.group_name_prefix}${local.auditor_group_name_suffix} to read buckets in tenancy", 
        "Allow group ${each.value.group_name_prefix}${local.auditor_group_name_suffix} to read nat-gateways in tenancy",
        "Allow group ${each.value.group_name_prefix}${local.auditor_group_name_suffix} to read public-ips in tenancy",
        "Allow group ${each.value.group_name_prefix}${local.auditor_group_name_suffix} to read file-family in tenancy",
        "Allow group ${each.value.group_name_prefix}${local.auditor_group_name_suffix} to read instance-configurations in tenancy",
        "Allow group ${each.value.group_name_prefix}${local.auditor_group_name_suffix} to read network-security-groups in tenancy",
        "Allow group ${each.value.group_name_prefix}${local.auditor_group_name_suffix} to read resource-availability in tenancy",
        "Allow group ${each.value.group_name_prefix}${local.auditor_group_name_suffix} to read audit-events in tenancy",
        ...
        "Allow group ${each.value.group_name_prefix}${local.auditor_group_name_suffix} to read vss-family in tenancy",
