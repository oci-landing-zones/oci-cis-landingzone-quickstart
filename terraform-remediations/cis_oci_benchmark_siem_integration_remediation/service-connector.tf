  ...
  service_connectors_configuration = {
    ...
    service_connectors : {
      SIEM-INTEGRATION-SERVICE-CONNECTOR : {
        ...
        policy : {
          name = local.default_service_connector_target_policy_name
        }
      }
    }
  }
...
module "vision_connector" {
  source                           = "github.com/oci-landing-zones/terraform-oci-modules-observability//service-connectors?ref=v0.2.3"
